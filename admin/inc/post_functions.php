...
function createPost($request_values)
{
		...
		// Get image name
	  	...
	  	$target = "../static/img/" . basename($featured_image);
...
{
	global $conn, $errors, $post_id, $title, $featured_image, $topic_id, $body;
	$title = esc($request_values['title']);
	...
	//if (isset($_POST['featured_image'])) {
		...
		if (count($errors) == 0) {
			$query = "UPDATE posts SET title='$title', slug='$post_slug', views=0, image='$featured_image', body='$body', updated_at=now() WHERE id=$post_id";
